...
DEFAULT_EKAEMR_TOOLS = ["authentication_elicitation", "search_patients","get_comprehensive_patient_profile","add_patient","list_patients","update_patient","archive_patient","get_patient_by_mobile","get_business_entities","doctor_discovery_tool","get_doctor_profile_basic","get_clinic_details_basic","get_doctor_services","get_comprehensive_doctor_profile","get_comprehensive_clinic_profile","get_available_dates","get_appointment_slots","doctor_availability_elicitation","book_appointment","show_appointments_enriched","show_appointments_basic","get_appointment_details_enriched","get_appointment_details_basic","get_patient_appointments_enriched","get_patient_appointments_basic","update_appointment","complete_appointment","cancel_appointment","get_prescription_details_basic","get_comprehensive_prescription_details","abha_send_otp","abha_verify_otp","abha_select_profile"]
